...
const jsVendorDestination = "./assets/js/vendor";
...
const textDomain = "ruven";

// Name of the translation file.
const translationFile = "ruven.pot";

// Where to save the translation files.
const translationDestination = "./languages";

// Package name.
const packageName = "ruven";

// Where can users report bugs.
const bugReport = "https://die-grafischen.ch";

// Last translator Email ID.
const lastTranslator = "Ivo Ivanov <ivo@die-grafischen.ch>";

// Team's Email ID.
const team = "Die Grafischen <hi@die-grafischen.ch>";
