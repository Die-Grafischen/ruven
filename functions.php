...
function ruven_register_styles() {
	...
	wp_enqueue_style( 'ruven-style', get_stylesheet_uri() . '/assets/css/main.css', array(), $theme_version );
...
function ruven_register_scripts() {
	...
	wp_enqueue_script( 'ruven-js', get_template_directory_uri() . '/assets/js/custom.js', array(), $theme_version, false );
